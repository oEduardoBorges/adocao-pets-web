...
import { AdocoesReprovarComponent } from './components/adocoes/adocoes-reprovar/adocoes-reprovar.component';
...
const routes: Routes = [
  ...
  {path: '', component: NavComponent, canActivate: [AuthGuard], children: [
    ...
    {path: 'adocoes/aprovar', component: AdocoesAprovarComponent, canActivate: [AuthGuard], data: { allowedRoles: ['ADMIN'] } },
    {path: 'adocoes/reprovar', component: AdocoesReprovarComponent, canActivate: [AuthGuard], data: { allowedRoles: ['ADMIN'] } }
